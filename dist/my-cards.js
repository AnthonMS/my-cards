 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const z=(t,...e)=>new M(t,e,"html",B)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const ie=new WeakMap,ne=w(t=>e=>{if(!(e instanceof N)||e instanceof D||"style"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:i}=e,{style:n}=i.element;let o=ie.get(e);void 0===o&&(n.cssText=i.strings.join(" "),ie.set(e,o=new Set)),o.forEach(e=>{e in t||(o.delete(e),-1===e.indexOf("-")?n[e]=null:n.removeProperty(e))});for(const e in t)o.add(e),-1===e.indexOf("-")?n[e]=t[e]:n.setProperty(e,t[e])}),oe=(t,e={})=>{switch(t){case"card":return se(e);case"container":return re(e);case"track":return ae(e);case"progress":return le(e);case"thumb":return ce(e);default:return void console.log("Getting default styles")}},se=t=>Object.assign({height:"125px"},t),re=t=>Object.assign({width:"100%",height:"100%",position:"relative",overflow:"hidden","border-radius":"5px"},t),ae=t=>Object.assign({width:"100%",height:"100%",position:"relative",background:"var(--card-background-color)"},t),le=t=>Object.assign({height:"100%",background:"var(--paper-item-icon-active-color)",position:"absolute",width:"0.00%"},t),ce=t=>Object.assign({height:"100%",background:"black",position:"absolute",right:"-5px",width:"10px"},t),de=function(t,e,i){var n,o;for(var s in e=void 0===e?[]:e,i=void 0===i?{}:i,t)t.hasOwnProperty(s)&&(n=s,o=t[s],e.push(n),"object"==typeof o&&null!==o?i=de(o,e,i):i[e[e.length-1]]=o,e.pop());return i},he=(t,e=100,i=0)=>t/(e-i)*100,ue=t=>Math.round(100*(t+Number.EPSILON))/100;console.info(`%c  ---- MY-SLIDER-V2 ---- \n%c  ${s("common.version")} 2.0.3    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: green"),window.customCards=window.customCards||[],window.customCards.push({type:"my-slider-v2",name:"Slider Card V2",description:"Custom Slider Card V2 for Lovelace."});let pe=class extends dt{constructor(){super(...arguments),this.sliderId="",this.touchInput=!1,this.disableScroll=!0,this.allowTapping=!0,this.vertical=!1,this.flipped=!1,this.inverse=!1,this.showMin=!1,this.savedMin=0,this.min=0,this.max=100,this.minThreshold=0,this.maxThreshold=100,this.step=1,this.sliderVal=0,this.sliderValPercent=0}setSliderValues(t,e){this.inverse?(this.sliderVal=this.max-t,this.sliderValPercent=100-e):(this.sliderVal=t,this.sliderValPercent=e)}static getStubConfig(){return{}}static get properties(){return{hass:{},config:{},active:{}}}setConfig(t){const e=["light","input_number","media_player","cover","fan","switch","lock"];if(!t.entity)throw new Error("You need to define entity");if(!e.includes(t.entity.split(".")[0]))throw new Error("Entity has to be one of the following: "+e.map(t=>" "+t));this.config=Object.assign({name:"MySliderV2"},t)}shouldUpdate(t){return!!this.config&&It(this,t,!1)}render(){var t,e,i,n,o,s,r,a,l,c;this.initializeConfig();const d=de(null===(t=this.config.styles)||void 0===t?void 0:t.card)?de(null===(e=this.config.styles)||void 0===e?void 0:e.card):{},h=de(null===(i=this.config.styles)||void 0===i?void 0:i.container)?de(null===(n=this.config.styles)||void 0===n?void 0:n.container):{},u=de(null===(o=this.config.styles)||void 0===o?void 0:o.track)?de(null===(s=this.config.styles)||void 0===s?void 0:s.track):{},p=de(null===(r=this.config.styles)||void 0===r?void 0:r.progress)?de(null===(a=this.config.styles)||void 0===a?void 0:a.progress):{},m=de(null===(l=this.config.styles)||void 0===l?void 0:l.thumb)?de(null===(c=this.config.styles)||void 0===c?void 0:c.thumb):{},g=oe("card",d),f=oe("container",h),v=oe("track",u),b=oe("progress",p),y=oe("thumb",m);this.vertical?(b.height=this.sliderValPercent.toString()+"%",b.width=p.width?p.width:"100%",b.right=p.right?p.right:"auto",y.right=m.right?m:"auto",y.width=m.width?m.width:"100%",y.height=m.height?m.height:"10px",this.flipped?(b.top=p.top?p.top:"0",y.bottom=m.bottom?m.bottom:"-5px"):(b.bottom=p.bottom?p.bottom:"0",y.top=m.top?m.top:"-5px")):(b.width=this.sliderValPercent.toString()+"%",this.flipped&&(b.right=p.right?p.right:"0",y.right=m.right?m.right:"auto",y.left=m.left?m.left:"-5px"));const _=t=>{const e=t.path.find(t=>t.classList.contains("my-slider-custom"));this.sliderEl=e||t.target},w=t=>{switch(t.type){case"mousedown":if(this.touchInput)return;x(t);break;case"touchstart":this.touchInput=!0,x(t);break;case"mousemove":if(this.touchInput)return;$(t);break;case"touchmove":this.disableScroll&&t.preventDefault(),$(t);break;case"mouseup":case"touchend":case"touchcancel":S(t)}},x=t=>{!0!==this.config.dragging&&(_(t),(this.allowTapping||t.path[0].classList.contains("my-slider-custom-thumb"))&&(this.config.dragging=!0,this.calcProgress(t)))},S=t=>{!1!==this.config.dragging&&(this.config.dragging=!1,(this.allowTapping||t.path[0].classList.contains("my-slider-custom-thumb"))&&this.calcProgress(t))},$=t=>{this.config.dragging&&this.calcProgress(t)};return this.createAndCleanupEventListeners(w),z`
            <ha-card style="${ne(g)}">
                <div class="my-slider-custom" id="${this.sliderId}" style="${ne(f)}" data-value="${this.sliderVal}" data-progress-percent="${this.sliderValPercent}"
                    @mousedown="${w}"
                    @mouseup="${w}"
                    @mousemove="${w}"
                    @touchstart="${w}"
