 ...
 * http://polymer.github.io/PATENTS.txt
 */
const w=new WeakMap,_=t=>(...e)=>{const i=t(...e);return w.set(i,!0),i},x=t=>"function"==typeof t&&w.has(t),S={},$={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const C=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),E=` ${c} `;class O{constructor(t,e,i,o){this.strings=t,this.values=e,this.type=i,this.processor=o}getHTML(){const t=this.strings.length-1;let e="",i=!1;for(let o=0;o<t;o++){const t=this.strings[o],n=t.lastIndexOf("\x3c!--");i=(n>-1||i)&&-1===t.indexOf("--\x3e",n+1);const r=f.exec(t);e+=null===r?t+(i?E:d):t.substr(0,r.index)+r[1]+r[2]+"$lit$"+r[3]+c}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");let e=this.getHTML();return void 0!==C&&(e=C.createHTML(e)),t.innerHTML=e,t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function Y(t){let e=I.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},I.set(t.type,e));let i=e.stringsArray.get(t.strings);if(void 0!==i)return i;const o=t.strings.join(c);return i=e.keyString.get(o),void 0===i&&(i=new h(t,t.getTemplateElement()),e.keyString.set(o,i)),e.stringsArray.set(t.strings,i),i}const I=new Map,B=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,i,o){const n=e[0];if("."===n){return new D(t,e.slice(1),i).parts}if("@"===n)return[new L(t,e.slice(1),o.eventContext)];if("?"===n)return[new A(t,e.slice(1),i)];return new N(t,e,i).parts}handleTextExpression(t){return new j(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const z=(t,...e)=>new O(t,e,"html",U)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
const Qt=new WeakMap,te=_(t=>e=>{if(!(e instanceof M)||e instanceof V||"style"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:i}=e,{style:o}=i.element;let n=Qt.get(e);void 0===n&&(o.cssText=i.strings.join(" "),Qt.set(e,n=new Set)),n.forEach(e=>{e in t||(n.delete(e),-1===e.indexOf("-")?o[e]=null:o.removeProperty(e))});for(const e in t)n.add(e),-1===e.indexOf("-")?o[e]=t[e]:o.setProperty(e,t[e])}),ee=(t,e={})=>{switch(t){case"card":return ie(e);case"container":return oe(e);case"track":return ne(e);case"progress":return re(e);case"thumb":return se(e);default:return void console.log("Getting default styles")}},ie=t=>Object.assign({height:"125px"},t),oe=t=>Object.assign({width:"100%",height:"100%",position:"relative",overflow:"hidden","border-radius":"5px"},t),ne=t=>Object.assign({width:"100%",height:"100%",position:"relative",background:"red","pointer-events":"none"},t),re=t=>Object.assign({height:"100%",background:"blue",position:"relative",width:"0.00%","pointer-events":"none"},t),se=t=>Object.assign({height:"100%",background:"purple",position:"absolute",right:"-5px",width:"10px","pointer-events":"none"},t);Object.prototype.deflate=function(t,e){var i,o;for(var n in t=void 0===t?[]:t,e=void 0===e?{}:e,this)this.hasOwnProperty(n)&&(i=n,o=this[n],t.push(i),"object"==typeof o&&null!==o?e=o.deflate(t,e):e[t[t.length-1]]=o,t.pop());return e};const ae=(t,e=100,i=0)=>t/(e-i)*100,le=t=>Math.round(100*(t+Number.EPSILON))/100;console.info(`%c  ---- MY-SLIDER-V2 ---- \n%c  ${r("common.version")} 2.0.3    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: green"),window.customCards=window.customCards||[],window.customCards.push({type:"my-slider-v2",name:"Slider Card V2",description:"Custom Slider Card V2 for Lovelace."});let ce=class extends dt{constructor(){super(...arguments),this.sliderId="",this.touchInput=!1,this.min=0,this.max=100,this.step=1,this.sliderVal=0,this.sliderValPercent=0}setSliderValues(t,e){this.sliderVal=t,this.sliderValPercent=e}static getStubConfig(){return{}}static get properties(){return{hass:{},config:{},active:{}}}setConfig(t){const e=["light","input_number","media_player","cover","fan","switch","lock"];if(!t.entity)throw new Error("You need to define entity");if(!e.includes(t.entity.split(".")[0]))throw new Error("Entity has to be one of the following: "+e.map(t=>" "+t));this.config=Object.assign({name:"MySliderV2"},t)}shouldUpdate(t){return!!this.config&&Lt(this,t,!1)}render(){var t,e,i,o,n,r,s,a,l,c;this.initializeConfig();const d=ee("card",null===(e=null===(t=this.config.styles)||void 0===t?void 0:t.card)||void 0===e?void 0:e.deflate()),u=ee("container",null===(o=null===(i=this.config.styles)||void 0===i?void 0:i.container)||void 0===o?void 0:o.deflate()),h=ee("track",null===(r=null===(n=this.config.styles)||void 0===n?void 0:n.track)||void 0===r?void 0:r.deflate()),p=ee("progress",null===(a=null===(s=this.config.styles)||void 0===s?void 0:s.progress)||void 0===a?void 0:a.deflate()),m=ee("thumb",null===(c=null===(l=this.config.styles)||void 0===l?void 0:l.thumb)||void 0===c?void 0:c.deflate());p.width=this.sliderValPercent.toString()+"%";const g=t=>{switch(t.type){case"mousedown":if(this.touchInput)return;f(t);break;case"touchstart":this.touchInput=!0,f(t);break;case"mousemove":if(this.touchInput)return;b(t);break;case"touchmove":this.config.disable_scroll&&t.preventDefault(),b(t);break;case"mouseup":case"touchend":case"touchcancel":v(t)}},f=t=>{this.sliderEl=t.target,!0!==this.config.dragging&&(this.config.dragging=!0,this.calcProgress(t))},v=t=>{!1!==this.config.dragging&&(this.config.dragging=!1,this.calcProgress(t))},b=t=>{this.config.dragging&&this.calcProgress(t)};return this.createAndCleanupEventListeners(g),z`
            <ha-card style="${te(d)}">
                <div class="my-slider-custom" id="${this.sliderId}" style="${te(u)}"
                    ...
                    @touchmove="${g}"
                >
                    <div class="my-slider-custom-track" style="${te(h)}">
        ...
        `}initializeConfig(){const t=this.config.entity;switch(this.entity=this.hass.states[""+t],this.sliderId="slider-"+this.config.entity.replace(".","-"),this.min=this.config.min?this.config.min:0,this.max=this.config.max?this.config.max:100,this.step=this.config.step?this.config.step:1,t.split(".")[0]){case"light":if("on"!==this.entity.state)break;if(this.config.warmth){const t=this.entity.attributes.color_temp,e=le(ae(t,this.max,this.min));this.setSliderValues(t,e)}else{const t=Math.round(this.entity.attributes.brightness/2.56),e=le(ae(t,this.max,this.min));this.setSliderValues(t,e)}break;case"input_number":this.min=this.entity.attributes.min,this.max=this.entity.attributes.max,this.step=this.entity.attributes.step;const t=this.entity.state,e=le(ae(t,this.max,this.min));this.setSliderValues(t,e);break;default:console.log("Default")}}calcProgress(t){if(null==this.sliderEl||null===this.sliderEl)return;const e=((t,e)=>{let i={x:0,y:0};if("touchstart"==t.type||"touchmove"==t.type||"touchend"==t.type||"touchcancel"==t.type){var o=void 0===t.originalEvent?t:t.originalEvent,n=o.touches[0]||o.changedTouches[0];i.x=n.pageX,i.y=n.pageY}else"mousedown"!=t.type&&"mouseup"!=t.type&&"mousemove"!=t.type&&"mouseover"!=t.type&&"mouseout"!=t.type&&"mouseenter"!=t.type&&"mouseleave"!=t.type||(i.x=t.clientX,i.y=t.clientY);var r=e.getBoundingClientRect();return{x:i.x-r.left,y:i.y-r.top}})(t,this.sliderEl),i=this.sliderEl.offsetWidth,o=le(ae(e.x,i))/100*(this.max-this.min);this.setProgress(this.sliderEl,Math.round(o),t.type)}setProgress(t,e,i){e>this.max?e=this.max:e<this.min&&(e=this.min);const o=t.querySelector(".my-slider-custom-progress"),n=le(ae(e,this.max,this.min));o.style.width=n.toString()+"%",this.sliderVal!==e&&((!this.config.intermediate||"mousemove"!==i&&"touchmove"!==i)&&(this.config.intermediate||"mouseup"!==i&&"touchend"!==i&&"touchcancel"!==i)||this.setValue(e,n))}setValue(t,e){if(this.entity)switch(this.setSliderValues(t,e),this.config.entity.split(".")[0]){case"light":this.config.warmth||this._setBrightness(this.entity,t);break;case"input_number":this._setInputNumber(this.entity,t);break;default:console.log("Default")}}_setBrightness(t,e){this.hass.callService("light","turn_on",{entity_id:t.entity_id,brightness:2.56*e})}_setInputNumber(t,e){this.hass.callService("input_number","set_value",{entity_id:t.entity_id,value:e})}createAndCleanupEventListeners(t){document.removeEventListener("mouseup",t),document.removeEventListener("touchend",t),document.removeEventListener("touchcancel",t),document.addEventListener("mouseup",t),document.addEventListener("touchend",t),document.addEventListener("touchcancel",t),document.addEventListener("mousemove",t)}static get styles(){return lt`
		`}};s([ot({attribute:!1})],ce.prototype,"hass",void 0),s([nt()],ce.prototype,"config",void 0),ce=s([et("my-slider-v2")],ce);const de="ontouchstart"in window||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0;class ue extends HTMLElement{constructor(){super(),this.holdTime=500,this.held=!1,this.ripple=document.createElement("mwc-ripple")}connectedCallback(){Object.assign(this.style,{position:"absolute",width:de?"100px":"50px",height:de?"100px":"50px",transform:"translate(-50%, -50%)",pointerEvents:"none",zIndex:"999"}),this.appendChild(this.ripple),this.ripple.primary=!0,["touchcancel","mouseout","mouseup","touchmove","mousewheel","wheel","scroll"].forEach(t=>{document.addEventListener(t,()=>{clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0},{passive:!0})})}bind(t,e){if(t.actionHandler)return;t.actionHandler=!0,t.addEventListener("contextmenu",t=>{const e=t||window.event;return e.preventDefault&&e.preventDefault(),e.stopPropagation&&e.stopPropagation(),e.cancelBubble=!0,e.returnValue=!1,!1});const i=t=>{let e,i;this.held=!1,t.touches?(e=t.touches[0].pageX,i=t.touches[0].pageY):(e=t.pageX,i=t.pageY),this.timer=window.setTimeout(()=>{this.startAnimation(e,i),this.held=!0},this.holdTime)},o=i=>{i.preventDefault(),["touchend","touchcancel"].includes(i.type)&&void 0===this.timer||(clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0,this.held?At(t,"action",{action:"hold"}):e.hasDoubleClick?"click"===i.type&&i.detail<2||!this.dblClickTimeout?this.dblClickTimeout=window.setTimeout(()=>{this.dblClickTimeout=void 0,At(t,"action",{action:"tap"})},250):(clearTimeout(this.dblClickTimeout),this.dblClickTimeout=void 0,At(t,"action",{action:"double_tap"})):At(t,"action",{action:"tap"}))};t.addEventListener("touchstart",i,{passive:!0}),t.addEventListener("touchend",o),t.addEventListener("touchcancel",o),t.addEventListener("mousedown",i,{passive:!0}),t.addEventListener("click",o),t.addEventListener("keyup",t=>{13===t.keyCode&&o(t)})}startAnimation(t,e){Object.assign(this.style,{left:t+"px",top:e+"px",display:null}),this.ripple.disabled=!1,this.ripple.active=!0,this.ripple.unbounded=!0}stopAnimation(){this.ripple.active=!1,this.ripple.disabled=!0,this.style.display="none"}}customElements.define("action-handler-my-footer",ue);const he=(t,e)=>{const i=(()=>{const t=document.body;if(t.querySelector("action-handler-my-footer"))return t.querySelector("action-handler-my-footer");const e=document.createElement("action-handler-my-footer");return t.appendChild(e),e})();i&&i.bind(t,e)},pe=_((t={})=>e=>{he(e.committer.element,t)}),me=t=>{if(!t)return"";let e="";return Object.keys(t).map(i=>{const o=t[i];e+=ge(i)+":"+o+";"}),e},ge=t=>t.split("").map((t,e)=>t.toUpperCase()===t&&"-"!==t?`${0!==e?"-":""}${t.toLowerCase()}`:t).join(""),fe=(t,e)=>{switch(t){case"my-button-card":return ve(e);case"my-button-icon":return be(e);case"my-button-label":return ye(e);case"my-button-label-vertical":return we(e);case"my-button-label-wrapper":return _e(e);case"my-button-slider":return xe(e);case"my-button-slider-vertical":return xe(e,!0);case"my-button-slider-wrapper":return ke(e);default:return void console.log("Getting default styles")}},ve=t=>(t||(t={}),Object.assign({height:t.height?t.height:"125px",width:t.width?t.width:"100%","min-width":"fit-content",background:t.background?t.background:"var(--card-background-color)"},t)),be=t=>(t||(t={}),Object.assign({height:t.height?t.height:"35px",width:t.width?t.width:"35px",display:t.display?t.display:"inline-block",padding:t.padding?t.padding:"10px 10px 10px 10px",cursor:"pointer",color:t.color?t.color:"var(--paper-item-active-icon-color)"},t)),ye=t=>(t||(t={}),Object.assign({padding:t.padding?t.padding:"0",margin:t.margin?t.margin:"0 10px",color:t.color?t.color:"var(--primary-text-color)","font-weight":"bold"},t)),we=t=>(t||(t={}),Object.assign({padding:0,margin:"0 10px",color:"var(--primary-text-color)","font-weight":"bold",transform:"rotate(270deg)"},t)),_e=t=>(t||(t={}),Object.assign({width:"30px",height:"100%",display:"flex","flex-direction":"column","justify-content":"center","align-items":"center","padding-left":"10px"},t)),xe=(t,e=!1)=>{if(t&&0!==Object.keys(t).length||(t={container:{},input:{},track:{},thumb:{}}),e){return{containerStyle:Ce(t.container?t.container:{}),inputStyle:Ee(t.input?t.input:{})}}return{containerStyle:Se(t.container?t.container:{}),inputStyle:$e(t.input?t.input:{}),trackStyle:Oe(t.track?t.track:{}),thumbStyle:Pe(t.thumb?t.thumb:{})}},Se=t=>(t||(t={}),Object.assign({height:"30px",position:"relative",overflow:"hidden","border-radius":"5px","--slider-color":"var(--paper-item-icon-active-color)"},t)),$e=t=>(t||(t={}),Object.assign({outline:"0",border:"0",width:"100%",height:"100%","border-radius":"5px","background-color":"#4d4d4d",margin:"0",transition:"box-shadow 0.2s ease-in-out",overflow:"hidden","-webkit-appearance":"none",position:"absolute",top:"0px",bottom:"0px",right:"0px",left:"0px","pointer-events":"auto"},t)),ke=t=>(t||(t={}),Object.assign({width:"30px",height:"100%",display:"flex","flex-direction":"column","justify-content":"center","align-items":"center","margin-right":"3px","pointer-events":"auto"},t)),Ce=t=>(t||(t={}),Object.assign(Object.assign({},t),{height:t.width?t.width:"30px",width:t.height?t.height:"calc(125px - 4px)",overflow:t.overflow?t.overflow:"hidden","border-radius":t["border-radius"]?t["border-radius"]:"5px","--slider-color":t.color?t.color:"#4d4d4d",display:t.flex?t.flex:"flex","flex-direction":t["flex-direction"]?t["flex-direction"]:"column","justify-content":t["justify-content"]?t["justify-content"]:"center","align-items":t["align-items"]?t["align-items"]:"center","-webkit-transform":t["-webkit-transform"]?t["-webkit-transform"]:"rotate(270deg)","-moz-transform":t["-moz-transform"]?t["-moz-transform"]:"rotate(270deg)","-o-transform":t["-o-transform"]?t["-o-transform"]:"rotate(270deg)","-ms-transform":t["-ms-transform"]?t["-ms-transform"]:"rotate(270deg)",transform:t.transform?t.transform:"rotate(270deg)","pointer-events":t["pointer-events"]?t["pointer-events"]:"auto"})),Ee=t=>(t||(t={}),Object.assign({outline:"0",border:"0","border-radius":"5px","background-color":"var(--paper-item-icon-active-color)",margin:"0",transition:"box-shadow 0.2s ease-in-out",overflow:"hidden","-webkit-appearance":"none","pointer-events":"auto"},t)),Oe=t=>(t||(t={}),Object.assign({height:"100%","-webkit-appearance":"none",color:"red",transition:"box-shadow 0.2s ease-in-out"},t)),Pe=t=>(t||(t={}),Object.assign({width:"25px",height:"80px","-webkit-appearance":"none",cursor:"ew-resize","border-radius":"0",transition:"box-shadow 0.2s ease-in-out",position:"relative","box-shadow":"-3500px 0 0 3500px var(--accent-color), inset 0 0 0 25px #FFFFFF",top:"calc((100% - 80px) / 2)","border-right":"10px solid var(--accent-color)","border-left":"10px solid var(--accent-color)","border-top":"20px solid var(--accent-color)","border-bottom":"20px solid var(--accent-color)","pointer-events":"auto"},t));console.info(`%c  ---- MY-BUTTON-LIGHT ---- \n%c  ${r("common.version")} 0.0.1    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: green"),window.customCards=window.customCards||[],window.customCards.push({type:"my-button-light",name:"Light Button Card",description:"Custom Light Button Card for Lovelace."});let Te=class extends dt{static getStubConfig(){return{}}static get properties(){return{hass:{},config:{},active:{}}}setConfig(t){if(!t.entity)throw new Error("You need to define entity");if(!t.entity.includes("light."))throw new Error("Entity has to be a light.");this.config=Object.assign({name:"MyButtonLight",disabled_scroll:!1},t)}shouldUpdate(t){return!!this.config&&Lt(this,t,!1)}render(){var t,e,i,o,n,r,s,a;const l=this.config.styles?this.config.styles:{},c=this.config.entity?this.config.entity:"ERROR: NO ENTITY ID",d=this.hass.states[""+c],u={show:!0,icon:"mdi:cog-outline"},h="string"==typeof this.config.icon?Object.assign(Object.assign({},u),{icon:this.config.icon}):"object"==typeof this.config.icon?Object.assign(Object.assign({},u),this.config.icon):u,p={show:!0,text:d.attributes.friendly_name},m="string"==typeof this.config.label?Object.assign(Object.assign({},p),{text:this.config.label}):"object"==typeof this.config.label?Object.assign(Object.assign({},p),this.config.label):p,g={min:0,max:100,step:"1",show:!0},f=this.config.slider?Object.assign(Object.assign({},g),this.config.slider):g,v=fe("my-button-card",l.card),b=fe("my-button-icon",l.icon),y=fe("my-button-label",l.label),{containerStyle:w,inputStyle:_,trackStyle:x,thumbStyle:S}=fe("my-button-slider",l.slider);this._trackStyle=me(x),this._thumbStyle=me(S),"on"===d.state?(v["color-on"]&&(v.background=v["color-on"]),b["color-on"]&&(b.color=b["color-on"]),y["color-on"]&&(y.color=y["color-on"]),w["color-on"]&&(w["--slider-color"]=w["color-on"])):(v["color-off"]&&(v.background=v["color-off"]),b["color-off"]?b.color=b["color-off"]:b.color="var(--paper-item-icon-color)",y["color-off"]&&(y.color=y["color-off"]),w["color-off"]?w["--slider-color"]=w["color-off"]:w["--slider-color"]="var(--paper-slider-secondary-color)");const $=()=>{this.config.disabled_scroll=!this.config.disabled_scroll,this.config.disabled_scroll?Xt(window):Gt(window)},k=t=>{this._setBrightness(d,t.target,f.min,f.max)};return z`
            <ha-card class="my-button-card" style="${me(v)}">
                <div class="flex-container">
                    ...
                    .actionHandler=${pe({hasDoubleClick:"none"!==(null===(e=null===(t=this.config)||void 0===t?void 0:t.double_tap_action)||void 0===e?void 0:e.action),hasHold:"none"!==(null===(o=null===(i=this.config)||void 0===i?void 0:i.hold_action)||void 0===o?void 0:o.action)})}>
                        ${(()=>{var t,e,i,o;return h.show?z`
                <ha-icon class="my-button-icon" icon="${h.icon}" style="${me(b)}"
                    @action=${t=>this._handleAction(t,this.config)}
                    .actionHandler=${pe({hasDoubleClick:"none"!==(null===(e=null===(t=this.config)||void 0===t?void 0:t.double_tap_action)||void 0===e?void 0:e.action),hasHold:"none"!==(null===(o=null===(i=this.config)||void 0===i?void 0:i.hold_action)||void 0===o?void 0:o.action)})} />
            `:z``})()}
                    </div>
            ...
            `:z``}
                    ...
                    <div class="row-3">
                        ${f.show?z`
                <div class="slider-container" style="${me(w)}">
                    <input name="slider" type="range" class="" style="${me(_)}"
        ...
        `}};s([ot({attribute:!1})],Te.prototype,"hass",void 0),s([nt()],Te.prototype,"config",void 0),Te=s([et("my-button-light")],Te),console.info(`%c  ---- MY-BUTTON-COVER ---- \n%c  ${r("common.version")} 0.0.1    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: green"),window.customCards=window.customCards||[],window.customCards.push({type:"my-button-cover",name:"Cover Button Card",description:"Custom Cover Button Card for Lovelace."});let Ne=class extends dt{static getStubConfig(){return{}}static get properties(){return{hass:{},config:{},active:{}}}setConfig(t){if(!t.entity)throw new Error("You need to define entity");if(!t.entity.includes("cover."))throw new Error("Entity has to be a cover.");this.config=Object.assign({name:"MyButtonCover",disabled_scroll:!1},t)}shouldUpdate(t){return!!this.config&&Lt(this,t,!1)}render(){var t,e,i,o,n;const r=this.config.styles?JSON.parse(JSON.stringify(this.config.styles)):{},s=this.config.entity?this.config.entity:"ERROR",a=this.hass.states[""+s],l={show:!0,icon:"",iconOpen:"mdi:blinds-open",iconClose:"mdi:blinds"},c="string"==typeof this.config.icon?Object.assign(Object.assign({},l),{icon:this.config.icon}):"object"==typeof this.config.icon?Object.assign(Object.assign({},l),this.config.icon):l,d={show:!0,text:a.attributes.friendly_name,vertical:!0},u="string"==typeof this.config.label?Object.assign(Object.assign({},d),{text:this.config.label}):"object"==typeof this.config.label?Object.assign(Object.assign({},d),this.config.label):d,h={min:0,max:100,step:"1"},p=this.config.slider?Object.assign(Object.assign({},h),this.config.slider):h,m=fe("my-button-card",r.card),g=fe("my-button-icon",r.icon),f=u.vertical?fe("my-button-label-vertical",r.label):fe("my-button-label",r.label),v=fe("my-button-label-wrapper",r["label-wrapper"]),{containerStyle:b,inputStyle:y}=fe("my-button-slider-vertical",r.slider),w=fe("my-button-slider-wrapper",null===(t=r.slider)||void 0===t?void 0:t.wrapper),_=()=>{this.config.disabled_scroll=!this.config.disabled_scroll,this.config.disabled_scroll?Xt(window):Gt(window)},x=t=>{this._setCover(a,t.target,p.min,p.max)};if("ERROR"===s)return z`<ha-card>Error: No Entity ID</ha-card>`;return z`
            ...
            `})()}
                ...
                <div style="${u.vertical?me(v):"display: block;"}"
                    @action=${t=>this._handleAction(t,u)}
                    .actionHandler=${pe({hasDoubleClick:"none"!==(null===(t=null==u?void 0:u.double_tap_action)||void 0===t?void 0:t.action),hasHold:"none"!==(null===(e=null==u?void 0:u.hold_action)||void 0===e?void 0:e.action)})}
                >

                    <label style="${me(f)}">${u.text}</label>
                </div>
            `:z``})()}
                                </div>
                                <div class="row-3"></div>
                            ...
                            <div style="${me(w)}">
                                <div class="slider-container" style="${me(b)}">
                                    <input name="slider" type="range" class="" style="${me(y)}"
                                        ...
                                        @touchstart="${p.toggle_scroll?_:null}"
                                        @touchend="${p.toggle_scroll?_:null}"
                                        @mousedown="${p.toggle_scroll?_:null}"
                                        @mouseup="${p.toggle_scroll?_:null}"
                                        @touchcancel="${p.toggle_scroll?_:null}"
                                    />
                                </div>
                            </div>
                        </div>
        ...
        `}};s([ot({attribute:!1})],Ne.prototype,"hass",void 0),s([nt()],Ne.prototype,"config",void 0),Ne=s([et("my-button-cover")],Ne),console.info(`%c  ---- MY-CARDS ---- \n%c  ${r("common.version")} 1.0.5    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: green");export{Ne as MyButtonCover,Te as MyButtonLight,Kt as MySlider,ce as MySliderV2};
